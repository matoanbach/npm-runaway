...
export function StackedRadialChartOneComponent() {
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        <CardTitle>Supplier Quality Statistics</CardTitle>
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        ...
        <div className="leading-none text-muted-foreground">
          Showing quality distribution for the last 6 months
        </div>
      </CardFooter>
    </Card>
  )
